...
- `/rrr:plan-phase` orchestrator (integrated research before planning)
- `/rrr:research-phase` orchestrator (standalone research)
...
<upstream_input>
**CONTEXT.md** (if exists) — User decisions from `/rrr:discuss-phase`
...
<downstream_consumer>
Your RESEARCH.md is consumed by `rrr-planner` which uses specific sections:
