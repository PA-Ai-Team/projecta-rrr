...
This document explains how RRR is written so future Claude instances can contribute consistently.

## Core Philosophy

RRR is a **meta-prompting system** where every file is both implementation and specification. Files teach Claude how to build software systematically. The system optimizes for:
...
### Slash Commands (`commands/rrr/*.md`)

```yaml
---
name: rrr:command-name
...
| Commands | `rrr:kebab-case` | `rrr:execute-phase` |
...
**Visual patterns:** `rrr/references/ui-brand.md`
