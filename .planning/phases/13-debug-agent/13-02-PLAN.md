...
<objective>
Refactor /rrr:debug command to thin orchestrator that spawns gsd-debugger agent.
...
<task type="auto">
  <name>Task 1: Refactor /rrr:debug to thin orchestrator</name>
  <files>commands/rrr/debug.md</files>
  <action>
Rewrite `commands/rrr/debug.md` as a thin orchestrator (~100-150 lines).
...
**Key changes:**
- Remove @~/.claude/rrr/workflows/debug.md reference
- Remove @~/.claude/rrr/references/debugging/*.md references
...
Does NOT reference workflows/debug.md or references/debugging/*.md.
  ...
  <done>
/rrr:debug is thin orchestrator that spawns gsd-debugger agent
  </done>
</task>

<task type="auto">
  <name>Task 2: Deprecate workflows/debug.md</name>
  <files>rrr/workflows/debug.md</files>
  <action>
Replace `rrr/workflows/debug.md` with a redirect notice.
...
**Migration:**
- `/rrr:debug` now spawns `gsd-debugger` agent directly
...
<task type="auto">
  ...
  <files>rrr/templates/debug-subagent-prompt.md</files>
  <action>
Simplify `rrr/templates/debug-subagent-prompt.md` since the agent now contains the expertise.
...
- [ ] commands/rrr/debug.md is <150 lines
- [ ] commands/rrr/debug.md uses subagent_type="gsd-debugger"
- [ ] commands/rrr/debug.md does NOT load workflow or reference files
...
- /rrr:debug refactored to thin orchestrator
