...
depends_on: ["13-01"]
files_modified:
  - rrr/references/debugging/debugging-mindset.md
  - rrr/references/debugging/hypothesis-testing.md
  - rrr/references/debugging/investigation-techniques.md
  - rrr/references/debugging/verification-patterns.md
  - rrr/references/debugging/when-to-research.md
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "rrr/references/debugging/debugging-mindset.md"
      provides: "Redirect to gsd-debugger agent"
      contains: "gsd-debugger"
  key_links:
    - from: "rrr/references/debugging/*.md"
...
- Similar to how `commands/`, `rrr/`, etc. are handled
