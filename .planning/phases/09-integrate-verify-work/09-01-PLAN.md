...
@commands/rrr/discuss-phase.md
@commands/rrr/consider-issues.md

**Pattern references (existing GSD workflows to match):**
@rrr/workflows/discuss-phase.md

**Pattern references (existing GSD templates to match):**
@rrr/templates/context.md
@rrr/templates/issues.md
</context>
...
<task type="auto">
  ...
  <files>rrr/workflows/verify-work.md</files>
  <action>
...
- Reference template for issues format: `@~/.claude/rrr/templates/uat-issues.md`
...
- Offer next actions based on results
  ...
  <verify>File exists at rrr/workflows/verify-work.md with proper XML structure</verify>
...
<task type="auto">
  ...
  <files>rrr/templates/uat-issues.md</files>
  <action>
...
- [ ] `rrr/workflows/verify-work.md` exists with proper XML structure
- [ ] `rrr/templates/uat-issues.md` exists with template format
- [ ] `commands/rrr/verify-work.md` delegates to workflow
