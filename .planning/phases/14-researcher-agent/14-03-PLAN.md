...
wave: 2
depends_on: ["14-01"]
files_modified: [commands/rrr/research-project.md, rrr/workflows/research-project.md, rrr/references/research-pitfalls.md]
autonomous: true

must_haves:
  truths:
    - "/rrr:research-project spawns parallel gsd-researcher agents"
  ...
  artifacts:
    - path: "commands/rrr/research-project.md"
      provides: "Thin orchestrator for project research"
      min_lines: 100
      contains: "gsd-researcher"
    - path: "rrr/workflows/research-project.md"
      provides: "Deprecation notice"
      contains: "DEPRECATED"
    - path: "rrr/references/research-pitfalls.md"
      provides: "Deprecation notice"
      contains: "DEPRECATED"
  key_links:
...
<objective>
Refactor /rrr:research-project to thin orchestrator that spawns parallel gsd-researcher agents + deprecate remaining files.
...
@commands/rrr/research-project.md
@rrr/workflows/research-project.md
@rrr/references/research-pitfalls.md
...
<task type="auto">
  ...
  <files>commands/rrr/research-project.md</files>
  <action>
Rewrite `commands/rrr/research-project.md` as a thin orchestrator (~150-180 lines).
...
9. Offer next steps (/rrr:define-requirements)
...
9. present_results - Show summary, offer /rrr:define-requirements
...
- Has validate, analyze, spawn_researchers, write_summary, git_commit steps
  ...
  <done>/rrr:research-project refactored to parallel orchestrator</done>
</task>

<task type="auto">
  <name>Task 2: Deprecate workflows/research-project.md</name>
  <files>rrr/workflows/research-project.md</files>
  <action>
Replace `rrr/workflows/research-project.md` with deprecation notice.
...
The `/rrr:research-project` command now spawns parallel gsd-researcher agents directly. Each agent handles one research domain (stack, features, architecture, pitfalls).
...
<task type="auto">
  ...
  <files>rrr/references/research-pitfalls.md</files>
  <action>
Replace `rrr/references/research-pitfalls.md` with deprecation notice.
...
- [ ] commands/rrr/research-project.md refactored (150-180 lines)
...
- /rrr:research-project is now a thin parallel orchestrator
