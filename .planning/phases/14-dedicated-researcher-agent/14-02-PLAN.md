...
wave: 2
depends_on: ["14-01"]
files_modified: [commands/rrr/research-phase.md, rrr/workflows/research-phase.md, rrr/templates/research-subagent-prompt.md]
autonomous: true
...
must_haves:
  ...
  artifacts:
    ...
    - path: "rrr/workflows/research-phase.md"
      provides: "Deprecation notice"
      contains: "DEPRECATED"
  key_links:
    - from: "commands/rrr/research-phase.md"
...
<task type="auto">
  <name>Task 1: Refactor /rrr:research-phase to thin orchestrator</name>
  <files>commands/rrr/research-phase.md</files>
  <action>
Rewrite commands/rrr/research-phase.md as thin orchestrator following the debug.md pattern:
...
Target: ~150 lines (down from ~84 lines command + ~450 lines workflow)
  ...
  <verify>
```bash
wc -l commands/rrr/research-phase.md
grep -c "gsd-researcher\|Task\|subagent_type" commands/rrr/research-phase.md
```
Expected: <200 lines, 3+ spawning references
  </verify>
  <done>commands/rrr/research-phase.md is thin orchestrator <200 lines, spawns gsd-researcher</done>
</task>
...
The `/rrr:research-phase` command spawns the gsd-researcher agent directly.
...
Keep file (don't delete) for git history traceability.
  ...
  <verify>
```bash
head -20 rrr/workflows/research-phase.md
```
...
Target: ~60 lines (context-only, agent has expertise)
  ...
  <verify>
```bash
wc -l rrr/templates/research-subagent-prompt.md
```
Expected: <100 lines
  </verify>
...
- [ ] commands/rrr/research-phase.md is <200 lines
