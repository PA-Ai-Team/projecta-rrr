...
wave: 2
depends_on: ["14-01"]
files_modified: [commands/rrr/research-project.md, rrr/workflows/research-project.md]
autonomous: true
...
must_haves:
  ...
  artifacts:
    ...
    - path: "rrr/workflows/research-project.md"
      ...
      contains: "DEPRECATED"
  key_links:
    - from: "commands/rrr/research-project.md"
...
<objective>
Refactor /rrr:research-project to spawn parallel gsd-researcher agents.
...
Pattern reference:
@commands/rrr/debug.md (thin orchestrator pattern)
...
<task type="auto">
  <name>Task 1: Refactor /rrr:research-project to thin orchestrator</name>
  <files>commands/rrr/research-project.md</files>
  <action>
Rewrite commands/rrr/research-project.md as thin orchestrator:
...
Target: ~180 lines (down from ~138 lines command + ~430 lines workflow)
  ...
  <verify>
```bash
wc -l commands/rrr/research-project.md
grep -c "gsd-researcher\|Task\|parallel" commands/rrr/research-project.md
```
Expected: <200 lines, 4+ spawning references
  </verify>
  <done>commands/rrr/research-project.md is thin orchestrator <200 lines, spawns 4 parallel agents</done>
</task>
...
The `/rrr:research-project` command spawns 4 parallel gsd-researcher agents:
...
Keep file for git history.
  ...
  <verify>
```bash
head -25 rrr/workflows/research-project.md
```
...
Keep full content below the notice for reference.
  ...
  <verify>
```bash
head -20 rrr/references/research-pitfalls.md
```
...
- [ ] commands/rrr/research-project.md is <200 lines
