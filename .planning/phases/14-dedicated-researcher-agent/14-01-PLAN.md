...
---
name: gsd-researcher
description: Conducts comprehensive research using systematic methodology, source verification, and structured output. Spawned by /rrr:research-phase and /rrr:research-project orchestrators.
