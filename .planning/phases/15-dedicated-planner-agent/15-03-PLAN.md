...
wave: 2
depends_on: ["15-01"]
files_modified: [rrr/references/principles.md, rrr/references/plan-format.md, rrr/references/scope-estimation.md, rrr/references/goal-backward.md, rrr/templates/phase-prompt.md]
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "rrr/references/principles.md"
      provides: "Deprecation notice pointing to agent"
      contains: "DEPRECATED"
    - path: "rrr/references/plan-format.md"
      provides: "Deprecation notice pointing to agent"
      contains: "DEPRECATED"
    - path: "rrr/references/scope-estimation.md"
      provides: "Deprecation notice pointing to agent"
      contains: "DEPRECATED"
    - path: "rrr/references/goal-backward.md"
      provides: "Deprecation notice pointing to agent"
      contains: "DEPRECATED"
  key_links:
...
<task type="auto">
  ...
  <files>rrr/references/principles.md, rrr/references/plan-format.md, rrr/references/scope-estimation.md, rrr/references/goal-backward.md</files>
  <action>
...
<task type="auto">
  ...
  <files>rrr/templates/phase-prompt.md</files>
  <action>
Add deprecation header to `rrr/templates/phase-prompt.md` while preserving content.
