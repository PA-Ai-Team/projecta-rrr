...
@rrr/references/principles.md
@rrr/workflows/plan-phase.md
@rrr/templates/phase-prompt.md
@rrr/references/plan-format.md
@rrr/references/scope-estimation.md
@rrr/references/checkpoints.md
@rrr/references/tdd.md
@rrr/references/goal-backward.md
</context>
...
1. `<role>` - Planning agent identity
   - Spawned by /rrr:plan-phase orchestrator
