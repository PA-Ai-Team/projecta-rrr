...
- ~/.claude/rrr/references/goal-backward.md (derivation process)
- ~/.claude/rrr/references/verification-patterns.md (detection patterns)
- ~/.claude/rrr/templates/verification-report.md (output format)
</required_reading>
...
See ~/.claude/rrr/references/goal-backward.md for detailed derivation guidance.
</step>
...
See ~/.claude/rrr/templates/verification-report.md for complete template.
</step>
