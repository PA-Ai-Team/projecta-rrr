...
Did you want to:
1. Complete current milestone first (/rrr:complete-milestone)
2. Add phases to current milestone (/rrr:add-phase)
...
- options (ALL THREE REQUIRED):
  - "Create milestone" - Proceed to /rrr:new-milestone
...
Use template from ~/.claude/rrr/templates/milestone-context.md
...
- Context handed off to /rrr:new-milestone
</success_criteria>
