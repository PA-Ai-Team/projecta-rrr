...
**If .planning/ doesn't exist:** This is a new project - route to /rrr:new-project
</step>
...
⚠️  Interrupted agent detected:
    ...
    Resume with: /rrr:resume-task

[If pending todos exist:]
📋 [N] pending todos — /rrr:check-todos to review
...
→ Primary: Resume interrupted agent (/rrr:resume-task)
...
1. Resume interrupted agent (/rrr:resume-task) [if interrupted agent found]
   OR
1. Resume from checkpoint (/rrr:execute-plan .planning/phases/XX-name/.continue-here-02-01.md)
   OR
1. Execute next plan (/rrr:execute-plan .planning/phases/XX-name/02-02-PLAN.md)
   OR
1. Discuss Phase 3 context (/rrr:discuss-phase 3) [if CONTEXT.md missing]
   OR
1. Plan Phase 3 (/rrr:plan-phase 3) [if CONTEXT.md exists or discuss option declined]
...
- **Plan phase** → Show command for user to run after clearing:
  ...
  **Also available:**
  - `/rrr:discuss-phase [N]` — gather context first
  - `/rrr:research-phase [N]` — investigate unknowns
