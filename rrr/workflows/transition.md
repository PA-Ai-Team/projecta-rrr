...
Exit skill and invoke SlashCommand("/rrr:plan-phase [X+1]")
...
**Also available:**
- `/rrr:discuss-phase [X+1]` — gather context first
- `/rrr:research-phase [X+1]` — investigate unknowns
- Review roadmap
...
Exit skill and invoke SlashCommand("/rrr:complete-milestone {version}")
