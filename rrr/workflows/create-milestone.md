...
1. ~/.claude/rrr/references/questioning.md
2. ~/.claude/rrr/templates/project.md
...
**If MILESTONE-CONTEXT.md exists (from /rrr:discuss-milestone):**
...
**Or research first:**
- `/rrr:research-project` — investigate ecosystem before scoping

**Full flow:**
1. `/rrr:define-requirements` — create REQUIREMENTS.md
2. `/rrr:create-roadmap` — create ROADMAP.md with phases
3. `/rrr:plan-phase [N]` — start execution
