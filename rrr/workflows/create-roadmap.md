...
1. ~/.claude/rrr/templates/roadmap.md
2. ~/.claude/rrr/templates/state.md
3. ~/.claude/rrr/templates/requirements.md
...
- NOT for scope creep or "nice to haves" (capture with /rrr:add-todo instead)
...
Use template from `~/.claude/rrr/templates/roadmap.md`.

Initial roadmaps use integer phases (1, 2, 3...).
Decimal phases added later via /rrr:insert-phase command (if it exists).
...
**If NEW_STATE:** Create fresh using template from `~/.claude/rrr/templates/state.md`.
