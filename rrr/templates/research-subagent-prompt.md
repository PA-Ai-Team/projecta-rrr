...
Template for spawning rrr-researcher agent. The agent contains all research expertise - this template provides research context only.
...
**From /rrr:research-phase:**
```python
Task(
  prompt=filled_template,
  subagent_type="rrr-researcher",
...
**Note:** Research methodology, tool strategy (Context7 > Official > WebSearch), and verification protocols are baked into the rrr-researcher agent. This template only passes context.
