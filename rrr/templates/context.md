...
- `rrr-phase-researcher` — Reads decisions to focus research (e.g., "card layout" → research card component patterns)
- `rrr-planner` — Reads decisions to create specific tasks (e.g., "infinite scroll" → task includes virtualization)
...
- `rrr-phase-researcher` uses decisions to focus investigation
- `rrr-planner` uses decisions + research to create executable tasks
