...
**New Slash Command:**
- Primary code: `commands/rrr/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `rrr/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `rrr/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/rrr/workflows/{name}.md`

**New Reference Document:**
- Implementation: `rrr/references/{name}.md`
