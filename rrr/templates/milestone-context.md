...
**Purpose:** Persist milestone discussion context so `/clear` can be used between commands. This file is consumed by `/rrr:new-milestone` and deleted after the milestone is created.
...
**Generated:** [date]
**Status:** Ready for /rrr:new-milestone
...
*This file is temporary. It will be deleted after /rrr:new-milestone creates the milestone.*
```
...
**Lifecycle:**
1. `/rrr:discuss-milestone` creates this file at end of discussion
2. User runs `/clear` (safe now - context is persisted)
3. `/rrr:new-milestone` reads this file
4. `/rrr:new-milestone` uses context to populate milestone
5. `/rrr:new-milestone` deletes this file after successful creation
