...
**Orchestrator role:** Parse arguments, validate phase, research domain (unless skipped or exists), spawn rrr-planner agent, verify plans with rrr-plan-checker, iterate until plans pass or max iterations reached, present results.
...
**If not found:** Error - user should run `/rrr:new-project` first.
...
Task(
  ...
  subagent_type="rrr-phase-researcher",
...
## 8. Spawn rrr-planner Agent

Display stage banner:
```
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
 RRR ► PLANNING PHASE {X}
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
<downstream_consumer>
Output consumed by /rrr:execute-phase or /rrr:execute-plan
...
## 10. Spawn rrr-plan-checker Agent
...
Task(
  ...
  subagent_type="rrr-plan-checker",
...
Spawn rrr-planner with revision prompt:
...
- `/rrr:plan-phase {X} --research` — re-research first
