...
- Example: `/rrr:add-phase Add authentication` → description = "Add authentication"
- Example: `/rrr:add-phase Fix critical performance issues` → description = "Fix critical performance issues"

If no arguments provided:

```
ERROR: Phase description required
Usage: /rrr:add-phase <description>
Example: /rrr:add-phase Add authentication system
```
...
2. Insert new phase heading:
   ...
   **Plans:** 0 plans
   ...
   Plans:
   - [ ] TBD (run /rrr:plan-phase {N} to break down)
...
- Don't use decimal numbering (that's /rrr:insert-phase)
- Don't create plans yet (that's /rrr:plan-phase)
