...
# Note: Cloudflare R2 is S3-compatible but uses Cloudflare credentials.
# Do NOT set AWS_REGION or use s3.amazonaws.com endpoints.
# Endpoint pattern: https://${CLOUDFLARE_ACCOUNT_ID}.r2.cloudflarestorage.com
