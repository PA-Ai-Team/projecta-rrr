...
- Example: `/rrr:remove-phase 17` → phase = 17
- Example: `/rrr:remove-phase 16.1` → phase = 16.1

If no argument provided:

```
ERROR: Phase number required
Usage: /rrr:remove-phase <phase-number>
Example: /rrr:remove-phase 17
```
...
To abandon current work, use /rrr:pause-work instead.
```
...
Would you like to:
- `/rrr:progress` — see updated roadmap status
