...
The unified /rrr:new-project flow includes requirements definition as Phase 7.
...
**Note:** For new projects, `/rrr:new-project` includes requirements definition. Use this command to redefine requirements later.
</objective>

<execution_context>
@~/.claude/rrr/references/principles.md
@~/.claude/rrr/workflows/define-requirements.md
