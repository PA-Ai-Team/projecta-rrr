...
The unified /rrr:new-project flow includes roadmap creation as Phase 8,
using the rrr-roadmapper agent for heavy lifting.
...
**Note:** For new projects, `/rrr:new-project` includes roadmap creation. Use this command to recreate roadmap later.
</objective>

<execution_context>
@~/.claude/rrr/references/principles.md
@~/.claude/rrr/workflows/create-roadmap.md
...
[ -f .planning/REQUIREMENTS.md ] || { echo "ERROR: No REQUIREMENTS.md found. Run /rrr:define-requirements first."; exit 1; }
```
</step>
...
**Also available:**
- `/rrr:discuss-phase 1` — gather context first
- Review roadmap
