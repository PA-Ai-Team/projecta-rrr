...
Output: Context gathered, then routes to /rrr:new-milestone
</objective>

<execution_context>
@~/.claude/rrr/references/principles.md
@~/.claude/rrr/workflows/discuss-milestone.md
</execution_context>
...
4. Hand off to /rrr:new-milestone with gathered context
