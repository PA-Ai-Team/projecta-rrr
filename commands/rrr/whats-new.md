---
name: rrr:whats-new
description: See what's new in RRR since your installed version
---
...
**To fix:** `npx projecta-rrr --global`
...
- URL: `https://raw.githubusercontent.com/PA-Ai-Team/projecta-rrr/main/CHANGELOG.md`
...
```bash
cat ~/.claude/rrr/CHANGELOG.md 2>/dev/null
```
...
**To update:** `npx projecta-rrr --global`
```
