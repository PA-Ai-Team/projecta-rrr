...
<!--
DEPRECATED: This command is now integrated into /rrr:new-project

The unified /rrr:new-project flow includes optional research as Phase 6.
...
For new projects, use /rrr:new-project instead.
...
**Note:** For new projects, `/rrr:new-project` includes research as an optional step. Use this command to re-research or add research later.
</objective>
...
<downstream_consumer>
Your STACK.md feeds into /rrr:create-roadmap. Be prescriptive:
...
<downstream_consumer>
Your FEATURES.md feeds into /rrr:define-requirements. Categorize clearly:
...
This section directly feeds into `/rrr:create-roadmap`.
...
---
## > Next Up
**Define requirements** - `/rrr:define-requirements`
<sub>`/clear` first</sub>
---
```
...
- [ ] 4 rrr-project-researcher agents spawned in parallel
