...
Run /rrr:new-project to start a new project.
```

Exit.

If missing STATE.md: suggest `/rrr:new-project`.

**If ROADMAP.md missing but PROJECT.md exists:**

This means a milestone was completed and archived. Go to **Route F** (between milestones).

If missing both ROADMAP.md and PROJECT.md: suggest `/rrr:new-project`.
</step>
...
## Pending Todos
- [count] pending — /rrr:check-todos to review
...
`/rrr:execute-plan [full-path-to-PLAN.md]`
...
**Also available:**
- `/rrr:discuss-phase {phase}` — gather context first
- `/rrr:list-phase-assumptions {phase}` — see Claude's assumptions
...
- Phase complete but next phase not planned → offer `/rrr:plan-phase [next]`
- All work complete → offer milestone completion
- Blockers present → highlight before offering to continue
- Handoff file exists → mention it, offer `/rrr:resume-work`
  </step>
...
- [ ] Smart routing: /rrr:execute-plan if plan exists, /rrr:plan-phase if not
- [ ] User confirms before any action
- [ ] Seamless handoff to appropriate rrr command
      </success_criteria>
